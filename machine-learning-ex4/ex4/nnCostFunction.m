...
a2 = [ones(m,1) a2'];
z3 = Theta2 * a2';
h_theta = sigmoid(z3); % h_theta equals 3
...
% Note we should not regularize the terms that corresponds to the bias 
...
for t=1:m
    ...
    %Step 1
    a1 = X(t,:); %X already have a bias unit at Line 45 (1*401)
    a1 = a1'; % (401*1)
    z2 = Theta1 * a1; % (25*401)*(401*1)
    a2 = sigmoid(z2); % (25*1)
    
    a2 = [1 ; a2]; % adding a bias unit (26*1)
